...
from src.website.models import Website, Page, Result, Block
...
def compare_blocks(website: Website):
    """
    First we are going to get the live blocks from the website and compare it with the blocks in the database
